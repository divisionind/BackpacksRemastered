...
public class FuzzyClassLookupException extends Exception {
    ...
    public FuzzyClassLookupException(String message) {
        super(message);
    }

    public FuzzyClassLookupException(Throwable cause) {
        super(cause);
    }

    public FuzzyClassLookupException(String message, Throwable cause) {
        super(message, cause);
    }
}
